...
# support files.
# Note that CORE_SAMPLE_DIR is either defined because the current project
# is Core, or because the current project has a dependency on Core, 
# in which case CORE_SAMPLE_DIR is an imported variable.
macro (set_install_directories)
  ...
  set (sampledir     ${CORE_SAMPLE_DIR})
  set (docdir        ${datarootdir}/doc/${PACKAGE}-${PACKAGE_VERSION})
  set (htmldir       ${docdir}/html)
  set (pdfdir        ${htmldir})
  set (mandir        ${datarootdir}/man)
  set (infodir       ${datarootdir}/info)
  set (pkgincludedir ${includedir}/core)
  set (pkglibdir     ${libdir}/core)
  set (pkglibexecdir ${libexecdir}/core)
...
# external libraries (e.g., Boost, SOCI, Core) are automatically
...
macro (module_library_add_specific
  ...
  #  * on external libraries (Boost, MySQL, SOCI, Core), as calculated by 
  ...
  foreach (man_sect ${man_section_list})
	...
	if (NOT "${_man_arg_MAN${man_sect}}" STREQUAL "")
	  ...
	  set (DOXYGEN_OUTPUT${man_sect}
		${man${man_sect}_DIR}/core-config.${man_sect})
...
macro (display_core)
  if (Core_FOUND)
    message (STATUS)
    message (STATUS "* Core:")
    message (STATUS "  - CORE_VERSION ................ : ${CORE_VERSION}")
    message (STATUS "  - CORE_BINARY_DIRS ............ : ${CORE_BINARY_DIRS}")
    message (STATUS "  - CORE_EXECUTABLES ............ : ${CORE_EXECUTABLES}")
    message (STATUS "  - CORE_LIBRARY_DIRS ........... : ${CORE_LIBRARY_DIRS}")
    message (STATUS "  - CORE_LIBRARIES .............. : ${CORE_LIBRARIES}")
    message (STATUS "  - CORE_INCLUDE_DIRS ........... : ${CORE_INCLUDE_DIRS}")
    message (STATUS "  - CORE_SAMPLE_DIR ............. : ${CORE_SAMPLE_DIR}")
  endif (Core_FOUND)
endmacro (display_core)
